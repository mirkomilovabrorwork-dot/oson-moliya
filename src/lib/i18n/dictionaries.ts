...
const uz: Dictionary = {
  ...
  "onboarding.example_debt": "Sarvarga 1 mln berdim",
  "onboarding.debt_hint": "Qarzlarni ham shunchaki yozing — kim qancha qarz, alohida hisoblanadi.",
  ...
  "home.debt_aside_given": "↗️ {amount} qarz berilgan — qaytishi kutiladi",
  "home.debt_aside_taken": "↘️ {amount} qarz olingan — qaytarish kerak",
  ...
  "accounts.explainer": "Har bir hisob balansi = boshlangʻich summa + shu hisobga bogʻlangan yozuvlar. Bosh sahifadagi umumiy balans esa barcha yozuvlarni hisoblaydi.",
  // ── Debts module
  "debt.title": "Qarzlar",
  ...
  "debt.original": "Asl",
  "debt.paid": "To'landi",
  "debt.remaining": "Qoldi",
  "debt.add_payment": "+ To'lov",
  "debt.mark_returned": "↩️ Qaytarildi",
  "debt.mark_repaid": "↩️ To'ladim",
  "debt.return.title": "Qaytarilganini belgilash",
  "debt.return.amount_label": "Qaytarilgan summa",
  "debt.repay.title": "To'langanini belgilash",
  "debt.repay.amount_label": "To'langan summa",
  "debt.payment.modal_title": "To'lov qo'shish",
  "debt.payment.amount_label": "Summa",
  "debt.payment.all": "Hammasi",
  ...
  // ── Recurring module
  "more.recurring": "Takroriy to'lovlar",
...
const ru: Dictionary = {
  ...
  "onboarding.example_debt": "Дал Сарвару 1 млн в долг",
  "onboarding.debt_hint": "Долги тоже просто пишите — кто кому должен, считается отдельно.",
  ...
  "home.debt_aside_given": "↗️ {amount} в долг отдано — ожидается возврат",
  "home.debt_aside_taken": "↘️ {amount} взято в долг — нужно вернуть",
  ...
  "accounts.explainer": "Баланс каждого счёта = начальная сумма + операции этого счёта. Общий баланс на главной учитывает все операции.",
  // ── Debts module
  "debt.title": "Долги",
  ...
  "debt.original": "Изначально",
  "debt.paid": "Оплачено",
  "debt.remaining": "Остаток",
  "debt.add_payment": "+ Платёж",
  "debt.mark_returned": "↩️ Возвращено",
  "debt.mark_repaid": "↩️ Оплачено",
  "debt.return.title": "Отметить как возвращённый",
  "debt.return.amount_label": "Возвращённая сумма",
  "debt.repay.title": "Отметить как погашённый",
  "debt.repay.amount_label": "Оплаченная сумма",
  "debt.payment.modal_title": "Добавить платёж",
  "debt.payment.amount_label": "Сумма",
  "debt.payment.all": "Всё",
  ...
  // ── Recurring module
  "more.recurring": "Регулярные платежи",
  "recurring.title": "Регулярные платежи",
  "recurring.empty.title": "Регулярных платежей нет",
  "recurring.empty.hint": "Аренда, зарплата, мобильная связь — настройте один раз, будут добавляться сами.",
  "recurring.add": "+ Новый регулярный",
  "recurring.add_short": "+ Новый",
  "recurring.form.type": "Тип",
  "recurring.form.category": "Категория",
  "recurring.form.amount": "Сумма",
  "recurring.form.frequency": "Периодичность",
  "recurring.form.monthly": "Ежемесячно",
  "recurring.form.yearly": "Ежегодно",
  "recurring.form.day_of_month": "День месяца",
  "recurring.form.month_of_year": "Месяц",
  "recurring.form.start_date": "Дата начала",
  "recurring.form.end_date": "Дата окончания (необязательно)",
  "recurring.form.note": "Примечание (необязательно)",
  "recurring.status.active": "Активный",
  "recurring.status.paused": "Приостановлен",
  "recurring.status.needs_category": "Нужна категория",
  "recurring.action.pause": "Приостановить",
  "recurring.action.resume": "Возобновить",
...
const en: Dictionary = {
  ...
  "onboarding.example_debt": "Lent Sarvar 1M",
  "onboarding.debt_hint": "Just write debts too — who owes what is tracked separately.",
  ...
  "home.debt_aside_given": "↗️ {amount} lent out — expected back",
  "home.debt_aside_taken": "↘️ {amount} borrowed — to repay",
  ...
  "accounts.explainer": "Each account's balance = its starting amount + the transactions linked to it. The total balance on Home counts all transactions.",
  // ── Debts module
  "debt.title": "Debts",
  "debt.given": "Lent out",
  "debt.taken": "Borrowed",
  ...
  "debt.add_payment": "+ Payment",
  "debt.mark_returned": "↩️ Returned",
  "debt.mark_repaid": "↩️ Repaid",
  "debt.return.title": "Mark as returned",
  "debt.return.amount_label": "Amount returned",
  "debt.repay.title": "Mark as repaid",
  "debt.repay.amount_label": "Amount repaid",
  "debt.payment.modal_title": "Add payment",
  "debt.payment.amount_label": "Amount",
  "debt.payment.all": "All",
  ...
  "recurring.empty.title": "No recurring payments yet",
  "recurring.empty.hint": "Rent, salary, phone bill — set up once, added automatically every period.",
  "recurring.add": "+ New recurring",
  "recurring.add_short": "+ New",
  "recurring.form.type": "Type",
  "recurring.form.category": "Category",
  "recurring.form.amount": "Amount",
  "recurring.form.frequency": "Frequency",
  "recurring.form.monthly": "Monthly",
  "recurring.form.yearly": "Yearly",
  "recurring.form.day_of_month": "Day of month",
  "recurring.form.month_of_year": "Month",
  ...
  "recurring.status.needs_category": "Needs category",
